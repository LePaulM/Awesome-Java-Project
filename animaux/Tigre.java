...
public class Tigre extends Charognard{
	 ...
	 * @param meurtFaim
	 */
	public Tigre(int dateNaissance, int dateDeces, boolean accesForet, /*Case emplacement,*/ int vitesse, boolean estVivant,
...
//		donne une espérance de vie autour de 16 tours à 4 tours près (soit 1/5)
		esperanceVie=16;
		Random r = new Random();
